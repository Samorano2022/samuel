...
import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-MZBOZM6V.js";
import {
  getStageColorByHex
} from "./chunk-WSNPKZRD.js";
import {
  LimitsModal
} from "./chunk-OS4RNIWA.js";
import {
...
} from "./chunk-TLHTSHQW.js";
import {
  useTypedSelector
} from "./chunk-HNR4STAZ.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-CWMBJJP2.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-3AT4YB5B.js";
import {
  index
} from "./chunk-KWHRFWUL.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-HUSYLBKN.js";
import {
  useConfig
} from "./chunk-BPT2NZ6W.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-LLNE3ZE6.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-YT526UIV.js";
import {
  renderAdmin,
  useDebounce
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-6KBLIZ67.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
var admin = {
  ...
  register(app) {
    app.addSettingsLink({
      ...
      id: "settings",
      to: "email",
      Component: () => import("./Settings-3Y3SSQOV.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-2XUT4R7E.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-6JUSE5U4.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      Component() {
        return import("./SettingsPage-S46DDMIL.js").then((mod) => ({
          default: mod.ProtectedSettingsPage
        }));
      },
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-HVVZSFEJ.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-D3TTUVGY.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./ReleasesSettingsPage-IIH6MSW3.js").then((mod) => ({
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-Q2PNYHC2.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./PurchaseContentReleases-WAGO2LQA.js").then((mod) => ({
...
function __variableDynamicImportRuntime3__2(path) {
  switch (path) {
    case "./translations/cs.json":
      return import("./cs.json-OKLQCJDY.js");
    case "./translations/en.json":
      return import("./en.json-GFW6E3ON.js");
    case "./translations/es.json":
      return import("./es.json-6VGU5KEH.js");
    case "./translations/nl.json":
      return import("./nl.json-3CQNTW6B.js");
    case "./translations/uk.json":
      return import("./uk.json-6UFAVEHY.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./router-YFLLEX4B.js").then((mod) => ({
            default: mod.Router
          }));
        }
      });
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-74SOZBTZ.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./purchase-review-workflows-76HNELS5.js").then((mod) => ({
...
//# sourceMappingURL=chunk-ZCMJSBXG.js.map
